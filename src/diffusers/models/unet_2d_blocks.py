...
def get_down_block(
    ...
    elif down_block_type == "AttnResnetDownsampleBlock2D":
        return AttnResnetDownsampleBlock2D(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
...
def get_up_block(
    ...
    elif up_block_type == "AttnResnetUpsampleBlock2D":
        return AttnResnetUpsampleBlock2D(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
...
class AttnResnetDownsampleBlock2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class AttnResnetUpsampleBlock2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        prev_output_channel: int,
